...
* hotel and plane requirements.
* An optional details field allows for additional notes or specific information related to that destination.
* 
* Used for type checking in API requests to ensure that the data being sent 
